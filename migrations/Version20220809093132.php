 ...
 */
final class Version20220809093132 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Relation OneToOne between User and Partner';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649BDE7F1C6 ON user (partners_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649BDE7F1C6 ON user');
