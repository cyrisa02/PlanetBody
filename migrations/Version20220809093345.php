 ...
 */
final class Version20220809093345 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Relation OneToOne between User and Sporthall';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D6495D6EC8DC ON user (sporthalls_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D6495D6EC8DC ON user');
